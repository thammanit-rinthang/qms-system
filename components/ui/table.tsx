...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto bg-white rounded-2xl border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b border-slate-100 bg-slate-50 sticky top-0 z-10", className)} {...props} />
))
